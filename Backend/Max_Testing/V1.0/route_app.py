...
def form():
    ...
    if form.validate_on_submit(): 
        ...
        return '<center><h1>Du bist Typ Baboon</h1></center> <break> <center><h2> Du hast bei Frage 1 {}. geantwortet <break> und bei Frage 2 {}. geantwortet </h2></center>'.format(form.q1.data, form.q2.data) #Insert jump to fitting Typ-Page here
