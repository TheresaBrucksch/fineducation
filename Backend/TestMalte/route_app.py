...
def form():
    ...
    if form.validate_on_submit():
        ...
        if Preserver > Follower and Preserver > Independent and Preserver > Accumulator:
            ...
            result = "Zu schwierig, sich zu entscheiden. Vielleicht braucht dieses Quiz mehr Fragen. Du bist geeignet als "
        ...
        return '<center><h1> Du bist Typ {} !</h1></center> <break> <center><h2> '.format(result)  # Insert jump to fitting Typ-Page here
